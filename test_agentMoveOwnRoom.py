"""Агент пересувається у існуючій кімнаті, але зображує шлях на 3D та 2D мапі"""
...
class SimpleExplorationAgent:
    ...
    def __init__(self, sim):
        ...
        self.yolo_stop_interval = 15 # Stop every n steps
        ...
        # Coverage tracking
        self.target_coverage = 50.0  # Target 30% coverage (optimal for testing, because no actual YOLO and the model is big)
        self.max_total_steps = 150   # Increased for better coverage
